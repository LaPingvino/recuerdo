...
# too general to claim. See for more info:
# https://bugs.launchpad.net/openteacher/+bug/1556510
BLACKLISTED_EXTENSIONS = ['xml.gz']
...
class SourceWithSetupSaverModule(object):
	...
	def _buildManPage(self, linuxDir, lang):
		...
		manPath = os.path.join(linuxDir, manName)
		try:
			subprocess.check_call(["rst2man", rstPath, manPath])
		except OSError:
			subprocess.check_call(['rst2man2', rstPath, manPath])
		os.remove(rstPath)
