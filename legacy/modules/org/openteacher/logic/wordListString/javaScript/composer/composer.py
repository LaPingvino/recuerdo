...
class JSWordListStringComposerModule(object):
	def __init__(self, moduleManager, *args, **kwargs):
		super(JSWordListStringComposerModule, self).__init__(*args, **kwargs)
	...
	def composeList(self, *args, **kwargs):
		return self._js.global_["composeList"](*args, **kwargs)
...
def init(moduleManager):
	return JSWordListStringComposerModule(moduleManager)
