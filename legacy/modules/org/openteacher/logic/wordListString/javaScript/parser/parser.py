...
class JSWordListStringParserModule(object):
	def __init__(self, moduleManager, *args, **kwargs):
		super(JSWordListStringParserModule, self).__init__(*args, **kwargs)
	...
	def parseList(self, listString, parseLenient=False):
		try:
			return self._js.global_["parseList"](listString, parseLenient)
...
def init(moduleManager):
	return JSWordListStringParserModule(moduleManager)
