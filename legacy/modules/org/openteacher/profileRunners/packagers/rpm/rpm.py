...
class RpmPackagerModule(object):
	...
	def _run(self):
		...
		if self._platform == "Fedora":
			requirements = "python2, python-qt5, python-qt5-webkit, espeak, python-chardet, python-enchant, tesseract, python-imaging, python-urwid"
		elif self._platform == "openSUSE":
			# add python-enchant if OpenSUSE adds it to the repos
			requirements = "python-qt5, espeak, python-chardet, tesseract-ocr, python-Pillow, python-urwid"
