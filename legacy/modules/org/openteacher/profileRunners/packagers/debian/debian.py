...
Depends: python-pyqt5, python-pyqt5.qtopengl, python-pyqt5.qtmultimedia, python-pyqt5.qtquick, python-pyqt5.qtwebkit, espeak, python-chardet, tesseract-ocr, python-enchant, python-urwid
			""".strip().format(
				package=packageName
			))
