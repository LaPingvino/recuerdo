...
class CourseHeroApi(object):
	...
	"""
	def __init__(self, userAgent, parse, getLanguageName, *args, **kwargs):
...
def installQtClasses():
	...
	class SearchDialog(QtWidgets.QDialog):
		...
		def __init__(self, *args, **kwargs):
			...
			self._searchButton = QtWidgets.QPushButton()
		...
		def retranslate(self):
			...
			self._searchBox.setPlaceholderText(_("E.g.: french"))
...
class CourseHeroApiModule(object):
	...
	def enable(self):
		...
		userAgent = self._modules.default('active', type='metadata').metadata['userAgent']
		self._api = CourseHeroApi(userAgent, self._parse, self._getLanguageName)
