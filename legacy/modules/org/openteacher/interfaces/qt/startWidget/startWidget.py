...
def installQtClasses():
	...
	class LargeStartWidgetButton(QtWidgets.QToolButton):
	...
	class SmallStartWidgetButton(QtWidgets.QToolButton):
		def __init__(self, *args, **kwargs):
			...
			self.setIcon(QtWidgets.QCommandLinkButton().icon())
			self.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)

	class ButtonsGroupBox(QtWidgets.QGroupBox):
		def __init__(self, customButtons=None, *args, **kwargs):
			super(ButtonsGroupBox, self).__init__(*args, **kwargs)

			self._buttons = {}

			self._smallLayout = QtWidgets.QVBoxLayout()
			self._largeLayout = QtWidgets.QGridLayout()
	...
	class StartWidget(QtWidgets.QSplitter):
		def __init__(self, recentlyOpenedViewer, *args, **kwargs):
			...
			openWidget = QtWidgets.QWidget(self)
