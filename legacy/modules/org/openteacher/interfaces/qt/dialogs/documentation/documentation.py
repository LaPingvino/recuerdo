...
def installQtClasses():
	...
	class OpenTeacherWebPage(QtWebKitWidgets.QWebPage):
	...
	class DocumentationDialog(QtWebKitWidgets.QWebView):
...
class DocumentationModule(object):
	...
	def enable(self):
		global QtCore, QtWebKitWidgets, QtNetwork
		try:
			from PyQt5 import QtCore, QtWebKitWidgets, QtNetwork
		except ImportError:
			return
