...
#	Copyright 2009-2013, 2017, Marten de Vries
...
def installQtClasses():
	...
	class NotesWidget(QtWidgets.QWidget):
		def __init__(self, noteCalculator, calculatePercents, *args, **kwargs):
			...
			self.highestLabel = QtWidgets.QLabel()
			self.averageLabel = QtWidgets.QLabel()
			self.lowestLabel = QtWidgets.QLabel()

			self.layout = QtWidgets.QFormLayout()
			self.layout.addRow(QtWidgets.QLabel(), self.highestLabel)
			self.layout.addRow(QtWidgets.QLabel(), self.averageLabel)
			self.layout.addRow(QtWidgets.QLabel(), self.lowestLabel)
				...
				if module.dataType == dataType and hasattr(module, "properties"):
					...
					if len(self.labels) == 0:
						for property in module.properties:
							label = QtWidgets.QLabel(property[0])
	...
	class TestsViewerWidget(QtWidgets.QSplitter):
		...
		def __init__(self, testTypes, noteCalculator, calculatePercents, createPercentNoteViewer=None, *args, **kwargs):
			...
			testsView = QtWidgets.QTableView()
			...
			horSplitter = QtWidgets.QSplitter()
	...
	class TestViewerWidget(QtWidgets.QWidget):
	...
	class TestsViewer(QtWidgets.QStackedWidget):
