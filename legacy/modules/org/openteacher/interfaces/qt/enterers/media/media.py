...
def installQtClasses():
	...
	class EnterItemList(QtWidgets.QListView):
	...
	class EnterWidget(QtWidgets.QSplitter):
		...
		def __init__(self,*args, **kwargs):
			...
			self.titlel = QtWidgets.QLabel()
			self.titleTextBox = QtWidgets.QLineEdit()
			...
			self.addLocalButton = QtWidgets.QPushButton()
			self.addLocalButton.clicked.connect(self.addLocalItems)
			self.addRemoteButton = QtWidgets.QPushButton()
			self.addRemoteButton.clicked.connect(self.addRemoteItems)

			leftBottom = QtWidgets.QHBoxLayout()
			...
			desceditW = QtWidgets.QWidget()
			desceditW.setLayout(desceditL)

			rightSplitter = QtWidgets.QSplitter(2)
		...
		def addLocalItems(self):
			...
			for filename in filenames:
				self.addItem(filename, remote=False)
		...
		def addRemoteItems(self):
			...
			url, dialog = QtWidgets.QInputDialog.getText(
				self,
				_("File URL"),
