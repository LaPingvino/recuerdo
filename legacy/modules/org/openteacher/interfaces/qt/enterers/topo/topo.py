...
def installQtClasses():
	...
	class EnterPlacesWidget(QtWidgets.QListWidget):
	...
	class EnterMapChooser(QtWidgets.QComboBox):
	...
	class EnterPlaceByName(QtWidgets.QLineEdit):
		...
		def updateKnownPlaces(self, knownPlaces):
			...
			self.completer = QtWidgets.QCompleter(self._getNames(knownPlaces))
	...
	class EnterWidget(QtWidgets.QSplitter):
		...
		def __init__(self, *args, **kwargs):
			...
			chooseMap = QtWidgets.QHBoxLayout()
			...
			#right side - top
			self.placesLabel = QtWidgets.QLabel()
			self.placesLabel.setWordWrap(True)

			self.removePlaceButton = QtWidgets.QPushButton()
			...
			#right side - bottom
			addPlace = QtWidgets.QHBoxLayout()

			self.addPlaceName = QtWidgets.QLabel()
			self.addPlaceName.setWordWrap(True)
			self.addPlaceButton = QtWidgets.QPushButton()
			...
			rightSideWidget = QtWidgets.QWidget()
