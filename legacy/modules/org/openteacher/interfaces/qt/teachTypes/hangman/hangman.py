...
def installQtClasses():
	...
	class HangmanTeachWidget(QtWidgets.QWidget):
		def __init__(self, wordModule, graphicsWidget, letterChosen, fadeDurationSetting, *args, **kwargs):
			...
			self.alreadyTriedLabel = QtWidgets.QLabel()
			self.triedLabel = QtWidgets.QLabel()
...
class TypingTeachTypeModule(object):
	...
	def enable(self):
		global QtCore, QtWidgets, graphics, word
		try:
