...
def installQtClasses():
	...
	class RepeatScreenWidget(QtWidgets.QWidget):
		def __init__(self, repeatAnswerTeachWidget, compose, getFadeDuration, *args, **kwargs):
			...
			self.showAnswerScreen = QtWidgets.QVBoxLayout()
			self.answerLabel = QtWidgets.QLabel()
	...
	class StartScreenWidget(QtWidgets.QWidget):
		def __init__(self, *args, **kwargs):
			...
			self.startScreen = QtWidgets.QVBoxLayout()
	...
	class RepeatAnswerTeachWidget(QtWidgets.QStackedWidget):
