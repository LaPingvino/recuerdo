...
def installQtClasses():
	...
	class ThinkWidget(QtWidgets.QWidget):
		def __init__(self, *args, **kwargs):
			super(ThinkWidget, self).__init__(*args, **kwargs)

			self.label = QtWidgets.QLabel()
			self.label.setWordWrap(True)
			self.viewAnswerButton = QtWidgets.QPushButton()
	...
	class AnswerWidget(QtWidgets.QWidget):
		def __init__(self, *args, **kwargs):
			...
			self.wrongButton = QtWidgets.QPushButton()
	...
	class InMindTeachWidget(QtWidgets.QStackedWidget):
