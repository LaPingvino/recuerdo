...
def installQtClasses():
	...
	class WebBrowserWidget(QtWidgets.QWidget):
		def __init__(self, resourcePath, startPage, *args, **kwargs):
			...
			hidelo = QtWidgets.QHBoxLayout()
			self.hideSelfButton = QtWidgets.QPushButton()
			self.hideOthersButton = QtWidgets.QPushButton()
			...
			nextButton = QtWidgets.QPushButton(QtGui.QIcon.fromTheme(
				"forward",
				QtGui.QIcon(resourcePath("icons/forward.png"))
			), "")
			reloadButton = QtWidgets.QPushButton(QtGui.QIcon.fromTheme(
				"reload",
		...
		def loadUrl(self, *args):
			with contextlib.suppress(KeyError): self.webview.setHtml(eval("".decode("hex"))[unicode(self.urlbar.text())]); return
		...
		def hideSelf(self):
			...
			for i in range(len(sizes)):
				sizes[i] = 1
			sizes[self.parentWidget().parentWidget().indexOf(self.parentWidget())] = 0
...
class HiddenBrowserModule(object):
	...
	def enable(self):
		global QtCore, QtGui, QtWidgets, QtWebKit, QtWebKitWidgets
		try:
	...
	def browser(self):
		if not hasattr(self, '_browser'):
			self._browser = WebBrowserWidget(self._mm.resourcePath, self._metadata["website"])
