...
def installQtClasses():
	...
	class NewUserDialog(QtWidgets.QDialog):
		def __init__(self, model, KeyboardWidget, *args, **kwargs):
			...
			self._explanationLabel = QtWidgets.QLabel()
			self._userNameLabel = QtWidgets.QLabel()
			self._userNameTextBox = QtWidgets.QLineEdit()
			self._layoutLabel = QtWidgets.QLabel()
			self._layoutComboBox = QtWidgets.QComboBox()
		...
		def _updatePreview(self, index):
			layoutName = self._layoutComboBox.itemData(index)
	...
	class ReadOnlyStringModel(QtCore.QStringListModel):
	...
	class LoginWidget(QtWidgets.QWidget):
		...
		def __init__(self, model, *args, **kwargs):
			...
			self._newUserButton = QtWidgets.QPushButton()
		...
		def _userClicked(self, index):
			username = index.data(QtCore.Qt.DisplayRole)
			self.userChosen.emit(username)
	...
	class InstructionsWidget(QtWidgets.QWidget):
		...
		def __init__(self, model, *args, **kwargs):
			...
			self._levelLabel = QtWidgets.QLabel()
			self._levelLabelLabel = QtWidgets.QLabel()
			self._speedLabel = QtWidgets.QLabel()
			self._speedLabelLabel = QtWidgets.QLabel()
			self._mistakesLabel = QtWidgets.QLabel()
			self._mistakesLabelLabel = QtWidgets.QLabel()
	...
	class MasterWidget(QtWidgets.QStackedWidget):
